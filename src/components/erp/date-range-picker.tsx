...
export const DateRangePicker = React.forwardRef<HTMLButtonElement, DateRangePickerProps>(
  (
    ...
    const formatDateMalaysian = (date: Date): string => {
    ...
    const formatDateRange = (): string => {
      ...
      if (!value.to) return formatDateMalaysian(value.from);
      return `${formatDateMalaysian(value.from)} - ${formatDateMalaysian(value.to)}`;
    };
    ...
    const inputId = id || `date-range-${label.toLowerCase().replace(/\s+/g, '-')}`;
